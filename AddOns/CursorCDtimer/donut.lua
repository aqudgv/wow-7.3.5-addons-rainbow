...
function addon.donut:New(direction, radius, thickness, color, bgColor, frame)
	...
	function donut:SetThickness(thickness)
		...
		for _,v in ipairs(self.background) do
			v:SetTexture("Interface\\Addons\\CursorCDtimer\\Textures\\segment_" .. thickness)
		end

		self.segment1:SetTexture("Interface\\Addons\\CursorCDtimer\\Textures\\segment_" .. thickness)
		self.segment2:SetTexture("Interface\\Addons\\CursorCDtimer\\Textures\\segment_" .. thickness)
		self.segment3:SetTexture("Interface\\Addons\\CursorCDtimer\\Textures\\segment_" .. thickness)
			
		self.red:SetTexture("Interface\\Addons\\CursorCDtimer\\Textures\\segment_" .. thickness)
		self.blue:SetTexture("Interface\\Addons\\CursorCDtimer\\Textures\\segment_" .. thickness)
	end
	...
	texture:SetTexture("Interface\\Addons\\CursorCDtimer\\Textures\\slice")
	donut.slice = texture
	-- Red part
