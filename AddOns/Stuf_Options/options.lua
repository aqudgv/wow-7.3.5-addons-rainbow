...
----------------------------------------------------------
	...
	if screenw > 1366 then
		playerx = floor(screenw * 0.27)
	else 
		playerx = floor(screenw * 0.2)
	end
	if screenh > 900 then
		playery = -floor(screenh * 0.75)
	else 
		playery = -floor(screenh * 0.66)
	end
	
	if justboss then
		db.boss1={
			frame={ x=arenax, y=arenay, w=150, h=36, bordercolormethod="classreaction", },
			portrait={ hide=true, x=-2, y=1, w=154, h=38, show3d=true, },
			hpbar={ x=-2, y=1, w=154, h=38, barcolormethod="hpred", bgcolormethod="hpreddark", baralpha=0.5, bgalpha=0, 
					bartexture="Frost", fade=true, reverse=true, framelevel=4, },
			mpbar={ x=-10, y=-25, w=90, h=8, barcolormethod="power", bgcolormethod="powerdark", bgalpha=0, reverse=true, framelevel=6, },
			text1={ 
				pattern="[name]", x=5, y=10, w=150, h=14, 
				fontsize=16, fontflags="OUTLINE", font="傷害數字", justifyH="RIGHT", justifyV="TOP", shadowx=2, shadowy=-2, framelevel=7,
			},

			text2={ pattern="[perchp]%", 
					x=0, y=-12, w=100, h=14, fontsize=14, font="傷害數字", fontflags="THICKOUTLINE", 
					justifyH="LEFT", justifyV="TOP", shadowx=1, shadowy=-1, framelevel=6, },
			text3={ 
				pattern="[curhp]", x=55, y=-12, w=100, h=12, 
				fontsize=12, fontflags="OUTLINE", justifyH="LEFT", justifyV="BOTTOM", framelevel=6,
			},
			text4={ pattern="[curmp]", x=2, y=-25, w=60, h=10, fontsize=11, justifyH="LEFT", justifyV="BOTTOM", shadowx=1, shadowy=-1, framelevel=6, },
			buffgroup={
				x=0, y=-42, w=12, h=12, 
			...
			debuffgroup={ 
				x=-15, y=-38, w=30, h=30, 
				count=8, rows=1, cols=8, growth="RLBT", spacing=1, onlymine=true, showpie=true, pieonlymine=true, push="None", 
			},
			infoicon={ hide=true, x=8, y=15, w=28, h=28, circular=true, framelevel=6, },
			castbar={ 
				x=-2, y=1, w=154, h=38, alpha=1,
				...
				spellfontcolor={ r=1, g=0.95, b=0.32, a=1, },
				timex=0, timey=0, timew=80, timeh=26, 
				timefontsize=8, timejustifyH="CENTER", timejustifyV="CENTER",
				timefontcolor={ r=1, g=0.5, b=0.2, a=0, },
				iconx=-16, icony=0, iconw=14, iconh=14, iconalpha=0, framelevel=10,
			},
			raidtargeticon={ x=-10, y=11, w=16, h=16, framelevel=8, },
			threatbar={ x=6, y=18, w=38, h=14, bgcolor={ r=0, g=0, b=0, a=0.4, }, fontsize=12, framelevel=10, },
		}
		for i = 2, MAX_BOSS_FRAMES, 1 do
			db["boss"..i]={ frame={ x=arenax, y=arenay - (73 * (i - 1)), w=150, h=36, }, }
		end
		db.boss1target={
			frame={ x=arenax + 158, y=arenay-5, w=78, h=24, },
			portrait={ x=55, y=0, w=24, h=24, show3d=nil, },
			hpbar={ x=1, y=-1, w=53, h=17, barcolormethod="classreaction", bgcolormethod="classreactiondark", reverse=true, bgalpha=0.3, },
		...
		for i = 2, MAX_BOSS_FRAMES, 1 do
			db["boss"..i.."target"]={ frame={ x=arenax + 158, y=arenay - (73 * (i - 1)) -3, w=78, h=24, }, }
		end
		return
	end
	...
	local defaults={
		...
		player={
			frame={ x=playerx, y=playery, w=200, h=50, bordercolormethod="class", },
			portrait={
				x=-2, y=0, w=204, h=50, show3d=true,
				bg="Flat Smooth", bgcolor={ r=0, g=0, b=0, a=0.4, },
			},
			hpbar={
				x=-2, y=0, w=204, h=52,
				fade=true, vertical=nil, reverse=nil, 
				barcolormethod="class", bgcolormethod="class", bgalpha=0, baralpha=0.2, framelevel=4, inc=true,
			},
			mpbar={ 
				x=110, y=-36, w=100, h=9, 
				fade=true, vertical=nil, reverse=nil, 
				barcolormethod="power", bgcolormethod="powerdark", bgalpha=0, framelevel=5,
			},
			text1={ 
				x=5, y=10, w=200, h=14,
				pattern="[name]",  
				fontsize=18, font="傷害數字",  justifyH="LEFT", justifyV="TOP", shadowx=-1, shadowy=-2, framelevel=7, fontflags="OUTLINE", 
			},
			text2={ 
				x=5, y=-10, w=140, h=12,
			...
			text3={ 
				x=95, y=-13, w=100, h=21, 
				pattern="[curhp]",
				fontsize=10, justifyH="RIGHT", justifyV="BOTTOM", framelevel=6,
			},
			text4={
				x=99, y=-35, w=100, h=11,
				pattern="[curmp]",
				fontsize=11, justifyH="RIGHT", justifyV="BOTTOM", shadowx=1, shadowy=-1, framelevel=6, fontflags="OUTLINE", 
			},
			text5={ 
				hide=true, x=95, y=-35, w=100, h=10,
				pattern="[percmp]%",
				fontsize=10, justifyH="RIGHT", justifyV="BOTTOM", framelevel=6,
			},
			text6={ 
				x=1, y=-25, w=200, h=14,
				pattern="[gray_if_dead:死亡][gray_if_ghost:靈魂]", font="傷害數字", 
				fontsize=20, justifyH="CENTER", justifyV="CENTER", shadowx=-1, shadowy=-1, framelevel=6,
			},
			text7={ hide=true, x=0, y=0, w=1, h=1, pattern="", fontsize=10, justifyH="CENTER", justifyV="CENTER", framelevel=6,},
			text8={x=95, y=-1, w=100, h=30, pattern="[perchp]%", fontsize=16, font="傷害數字", justifyH="RIGHT", justifyV="CENTER", shadowx=-2, shadowy=-1, framelevel=6, },
			combattext={ hide=true, x=0, y=-20, w=52, h=14, fontsize=12, justifyH="CENTER", justifyV="TOP", shadowx=-1, shadowy=-1, framelevel=6, },
			grouptext={ 
				x=10, y=-25, w=14, h=12,
				fontsize=14, font="傷害數字", justifyH="CENTER", justifyV="CENTER", shadowx=-1, shadowy=-1,
				bgcolor={ r=0, g=0, b=0, a=0.3, }, framelevel=6,
			},
			buffgroup={ hide=true, x=0, y=-57, w=20, h=20, count=20, rows=2, cols=10, },
			debuffgroup={ x=200, y=20, w=36, h=36, count=15, rows=3, cols=5, push="None", spacing=1, vspacing=1, showpie=true, counttfontflags="OUTLINE", growth="RLBT", },
			tempenchant={ x=-5, y=-50, w=36, h=36, count=2, growth="RLBT", },
			dispellicon={ x=108, y=10, w=48, h=48, framelevel=10, },
			voiceicon={ x=-7, y=7, w=16, h=16, framelevel=8,},
			pvpicon={ x=-12, y=-12, w=20, h=20, framelevel=6, },
			statusicon={ x=-14, y=-40, w=24, h=24, framelevel=6, },
			leadericon={ x=7, y=26, w=20, h=20, framelevel=6, },
			looticon={ x=7, y=-40, w=20, h=20, framelevel=6, },
			raidtargeticon={ hide=true, x=193, y=8, w=16, h=16, framelevel=6, },
			infoicon={ hide=true, x=175, y=10, w=20, h=20, circular=true, framelevel=6, },
			totembar={ x=25, y=17, w=32, h=14, bgcolor={ r=0, g=0, b=0, a=0.4, }, framelevel=8, },
			runebar={ x=40, y=0, w=38, h=6, bgcolor={ r=0, g=0, b=0, a=0.4, }, },
			druidbar={
				hide=true, x=110, y=-45, w=100, h=3,
			...
			castbar={ 
				hide=true, x=-2, y=1, w=204, h=52, alpha=1,
				baralpha=0, bgcolor={ r=1, g=1, b=0, a=0.2, },
				spellx=5, spelly=-38, spellw=193, spellh=14, 
				...
				timefontcolor={ r=1, g=0.5, b=0.2, a=0, },
				iconx=85, icony=-27, iconw=20, iconh=20, iconalpha=0, framelevel=9,
			},
			vehicleicon={ hide=true, x=-10, y=-43, w=20, h=20, framelevel=6,},
			holybar={ x=0, y=3, },
			shardbar={ x=0, y=-3, },
			chibar={ x=0, y=15, },
			priestbar={ x=0, y=0, },
		...
		target={
			frame={ x=screenw-playerx-200, y=playery, w=200, h=50, bordercolormethod="classreaction", },
			portrait={
				x=-2, y=0, w=204, h=50, show3d=true,
				bg="Flat Smooth", bgcolor={ r=0, g=0, b=0, a=0.4, },
			},
			hpbar={
				...
				barcolormethod="classreaction", bgcolormethod="classreactiondark", bgalpha=0, baralpha=0.2, framelevel=4, inc=true, 
			},
			mpbar={ 
				x=-10, y=-36, w=100, h=9, 
				fade=true, vertical=nil, reverse=true, hflip=true,
			...
			text1={ 
				...
				pattern="[name]", 
				x=-5, y=10, w=200, h=14, 
				fontsize=18, font="傷害數字", justifyH="RIGHT", justifyV="TOP", shadowx=-1, shadowy=-2, framelevel=7, fontflags="OUTLINE", 
			},
			text2={ 
				pattern="[difficulty:level][difficulty:classification] [class_if_npc:creaturetype][class_if_pc:race]", 
				x=53, y=-11, w=140, h=12, 
				fontsize=12, justifyH="RIGHT", justifyV="TOP", shadowx=-1, shadowy=-1, framelevel=6,
			},
			text3={ 
				pattern="[curhp]", 
				x=5, y=-13, w=100, h=21, 
				fontsize=10, justifyH="LEFT", justifyV="BOTTOM", framelevel=6,
			},
			text4={ 
				pattern="[curmp]", 
				x=5, y=-35, w=100, h=11, 
				fontsize=11, justifyH="LEFT", justifyV="BOTTOM", shadowx=1, shadowy=-1, framelevel=6, 
			},
			text5={ hide=true, pattern="[percmp]%", x=5, y=-35, w=100, h=10, fontsize=10, justifyH="LEFT", justifyV="BOTTOM", framelevel=6, },
			text6={ 
				pattern="[gray_if_oor:距離過遠][gray_if_tapped:TAPPED][gray_if_offline:離線][gray_if_dead:死亡][gray_if_ghost:靈魂]",
				x=1, y=-25, w=200, h=14, font="傷害數字", 
				fontsize=20, justifyH="CENTER", justifyV="CENTER", framelevel=6,
			},
			text7={ hide=true, pattern="", x=0, y=0, w=1, h=1, fontsize=10, justifyH="CENTER", justifyV="CENTER", framelevel=6, },
			text8={ pattern="[perchp]%", x=4, y=-1, w=100, h=30, fontsize=16, font="傷害數字", justifyH="LEFT", justifyV="CENTER", shadowx=2, shadowy=-1, framelevel=6, },
			combattext={ hide=true, x=145, y=-20, w=52, h=14, fontsize=12, justifyH="CENTER", justifyV="TOP", shadowx=-1, shadowy=-1, framelevel=6, },
			grouptext={ 
				x=177, y=-27, w=14, h=12,
				fontsize=14, font="傷害數字", justifyH="CENTER", justifyV="CENTER", shadowx=-1, shadowy=-1,
				bgcolor={ r=0, g=0, b=0, a=0.3, }, framelevel=6,
			},
			buffgroup={ 
				x=0, y=-57, w=20, h=20, 
				count=20, rows=2, cols=10, growth="LRTB", 
			},
			debuffgroup={ 
				x=5, y=20, w=36, h=36, 
				count=15, rows=3, cols=5, growth="LRBT", push="None", showpie=true, spacing=1, vspacing=1, pieonlymine=true, onlymine=true, 
			},
			auratimers={
				hide=true, x=210, y=-90, w=70, h=13,
				count=12, rows=6, cols=2, growth="TBLR", push="v",
			},
			dispellicon={ x=42, y=10, w=48, h=48, framelevel=10, },
			pvpicon={ x=192, y=-10, w=20, h=20, framelevel=6, },
			statusicon={ x=190, y=-40, w=24, h=24, framelevel=6, },
			leadericon={ x=173, y=26, w=20, h=20, framelevel=6, },
			looticon={ x=173, y=-40, w=20, h=20, framelevel=6, },
			raidtargeticon={ x=-10, y=8, w=16, h=16, framelevel=8, },
			infoicon={ x=6, y=10, w=20, h=20, circular=true, framelevel=6, },
			castbar={ 
				x=-2, y=1, w=204, h=52, alpha=1,
				baralpha=0, bgcolor={ r=1, g=1, b=0, a=0.2, },
				spellx=5, spelly=-38, spellw=191, spellh=14, 
				spellfontsize=14, spellfontflags="THICKOUTLINE", spelljustifyH="CENTER", spelljustifyV="CENTER", spellshadowx=-1, spellshadowy=-1,
				spellfontcolor={ r=1, g=0.95, b=0.32, a=1, },
			...
			comboframe={ 
				...
				glowcolor={ r=1, g=1, b=0, a=0.8, }, framelevel=10,
			},
			inspectbutton={ x=192, y=-25, w=20, h=20, framelevel=6, },
			threatbar={ x=2, y=22, w=40, h=14, fontsize=12, bgcolor={ r=0, g=0, b=0, a=0.4, }, framelevel=8,},
			rangetext={ x=15, y=20, w=100, h=10, fontsize=12, justifyH="CENTER", framelevel=12, },
		},
		targettarget={
			frame={ x=screenw-playerx+8, y=playery-8, w=78, h=24, },
			portrait={ x=0, y=0, w=24, h=24, show3d=nil, },
			hpbar={ x=25, y=-1, w=53, h=17, barcolormethod="classreaction", bgcolormethod="classreactiondark", bgalpha=0.3, },
			...
			buffgroup={ hide=true, x=0, y=-24, w=10, h=10, count=8, rows=1, cols=8, },
			debuffgroup={ hide=true, x=0, y=-24, w=10, h=10, count=8, rows=1, cols=8, push="v", },
		...
		targettargettarget={
			frame={ hide=true, x=screenw-playerx+52, y=playery+5, w=36, h=12, },
		...
		focus={
			frame={ x=playerx, y=playery+200, w=150, h=36, bordercolormethod="classreaction", },
			portrait={ x=-2, y=1, w=154, h=38, show3d=true, },
			...
			mpbar={ x=70, y=-25, w=90, h=8, barcolormethod="power", bgcolormethod="powerdark", bgalpha=0, framelevel=6, },
			text1={ 
				pattern="[reaction:name]", 
				x=5, y=10, w=150, h=14, 
			...
			debuffgroup={ 
				x=150, y=18, w=24, h=24, 
				count=12, rows=2, cols=6, growth="RLBT", push="None", showpie=true, spacing=1, vspacing=1, pieonlymine=true,
			},
			auratimers={
				x=-60, y=-40, w=50, h=12,
		...
		focustarget={
			frame={ x=playerx+155, y=playery+195, w=36, h=12, },
			portrait={ x=0, y=0, w=12, h=12, },
			hpbar={ 
				x=12, y=0, w=24, h=9, 
				barcolormethod="hpgreen", bgcolormethod="hpgreendark", bgalpha=0.3, 
		...
		pet={
			frame={ x=playerx-220, y=playery-14, w=150, h=36, bordercolormethod="classreaction", },
			portrait={ x=-2, y=1, w=154, h=38, show3d=true, 
				bg="Flat Smooth", bgcolor={ r=0, g=0, b=0, a=0.4, },
			},
			hpbar={
				...
				barcolormethod="classreaction", bgcolormethod="classreactiondark", bgalpha=0, baralpha = 0.3, framelevel=4,
			},
			mpbar={ 
				x=70, y=-25, w=90, h=8, 
				fade=nil, vertical=nil, reverse=nil, hflip=nil,
				barcolormethod="power", bgcolormethod="powerdark", bgalpha=0, framelevel=6, 
			},
			text1={ 
				pattern="[name]", 
				x=5, y=10, w=150, h=14, 
				fontsize=16, justifyH="LEFT", justifyV="TOP", shadowx=2, shadowy=-2, framelevel=7, fontflags="OUTLINE", 
			},
			text2={ 
			...
			text4={ 
				pattern="[curmp]", 
				x=87, y=-24, w=60, h=10, 
				fontsize=10, justifyH="RIGHT", justifyV="BOTTOM", framelevel=10,  
			},
			text5={ hide=true, pattern="[percmp]%", x=86, y=-25, w=60, h=10, fontsize=10, justifyH="RIGHT", justifyV="BOTTOM", framelevel=6,  },
			text6={ 
				pattern="[gray_if_dead:死亡]",
				x=10, y=-20, w=189, h=14, font="傷害數字", 
				fontsize=14, justifyH="LEFT", justifyV="CENTER", framelevel=6, 
			},
			combattext={ hide=true, x=-1, y=-20, w=52, h=14, fontsize=12, justifyH="CENTER", justifyV="TOP", framelevel=6, },
			buffgroup={ 
				x=0, y=-42, w=12, h=12, 
				count=20, rows=2, cols=10, growth="LRTB",
			},
			debuffgroup={ 
				x=150, y=18, w=24, h=24, 
				count=12, rows=2, cols=6, growth="RLBT", push="None", showpie=true, spacing=1, vspacing=1, 
			},
			dispellicon={ x=70, y=12, w=36, h=36, framelevel=12, },
			statusicon={ x=-12, y=-26, w=20, h=20, framelevel=6, },
			raidtargeticon={ x=144, y=11, w=16, h=16, framelevel=6, },
			infoicon={ hide=true, x=115, y=15, w=28, h=28, framelevel=6, circular=true, },
			castbar={ 
				hide=true, x=-2, y=1, w=154, h=38, alpha=1,
				baralpha=0, bgcolor={ r=1, g=1, b=0, a=0.2, },
				spellx=0, spelly=-26, spellw=150, spellh=14, 
				spellfontsize=14, spellfontflags="THICKOUTLINE", spelljustifyH="LEFT", spelljustifyV="CENTER", spellshadowx=-1, spellshadowy=-1,
				spellfontcolor={ r=1, g=0.95, b=0.32, a=0.7, },
				timex=0, timey=-30, timew=147, timeh=10, 
				timefontsize=10, timejustifyH="CENTER", timejustifyV="CENTER",
				timefontcolor={ r=1, g=0.5, b=0.2, a=0, },
				iconx=62, icony=-26, iconw=12, iconh=12, iconhide=true, framelevel=6,
			},
			pettime={ x=110, y=0, w=36, h=10, fontsize=16, shadowx=-1, shadowy=-1, framelevel=6, },
		},
		party1={ 
			frame={ x=16, y=-120, w=150, h=36, bordercolormethod="class",}, 
			portrait={ hide=true, x=-2, y=1, w=154, h=38, show3d=true, 
				bg="Flat Smooth", bgcolor={ r=0, g=0, b=0, a=0, },
			},
			hpbar={
				x=-2, y=1, w=154, h=38,
				fade=true, vertical=nil, reverse=nil, hflip=nil,
				barcolormethod="class", bgcolormethod="classdark", bgalpha=0, baralpha=0.5, framelevel=4,
			},
			mpbar={ 
				x=70, y=-25, w=90, h=8, 
				fade=nil, vertical=nil, reverse=nil, hflip=nil,
			...
			text3={ 
				pattern="[curhp] | [perchp]%", 
				x=0, y=-12, w=150, h=12, 
				fontsize=11, justifyH="RIGHT", justifyV="BOTTOM", framelevel=6, fontflags="OUTLINE", 
			},
			text4={ 
				hide=true, pattern="[curmp]", 
				x=87, y=-24, w=60, h=10, 
			...
			text5={ hide=true, pattern="[percmp]%", x=86, y=-24, w=60, h=10, fontsize=10, justifyH="RIGHT", justifyV="BOTTOM", framelevel=6, },
			text6={ 
				pattern="[gray_if_oor:距離過遠][gray_if_dead:死亡][gray_if_ghost:靈魂][gray_if_offline:離線]",
				x=10, y=-20, w=150, h=14, font="傷害數字", 
				fontsize=14, justifyH="LEFT", justifyV="CENTER", framelevel=6,
			},
			combattext={ hide=true, x=-1, y=-20, w=50, h=14, fontsize=12, justifyH="CENTER", justifyV="TOP", framelevel=6, },
			buffgroup={ 
				x=0, y=-42, w=12, h=12, 
				count=20, rows=2, cols=10,
			},
			debuffgroup={ 
				x=160, y=-38, w=30, h=30, 
				count=8, rows=1, cols=8, growth="LRBT", push="None", showpie=true, spacing=1, vspacing=1,
			},
			dispellicon={ x=70, y=12, w=36, h=36, framelevel=12, },
			voiceicon={ x=-7, y=7, w=16, h=16, framelevel=10, },
			pvpicon={ x=-13, y=-5, w=20, h=20, framelevel=6, },
			statusicon={ x=-12, y=-26, w=20, h=20, framelevel=6, },
			leadericon={ x=7, y=25, w=18, h=18, framelevel=6, },
			looticon={ x=5, y=-26, w=18, h=18, framelevel=6, },
			raidtargeticon={ x=144, y=11, w=16, h=16, framelevel=8, },
			infoicon={ x=115, y=15, w=28, h=28, framelevel=6, circular=true, },
			castbar={ 
				hide=true, x=-2, y=1, w=154, h=38, alpha=1,
				baralpha=0, bgcolor={ r=1, g=1, b=0, a=0.2, },
				spellx=0, spelly=-26, spellw=150, spellh=14, 
				...
				timefontsize=10, timejustifyH="CENTER", timejustifyV="CENTER",
				timefontcolor={ r=1, g=0.5, b=0.2, a=0, },
				iconx=62, icony=-26, iconw=12, iconh=12, iconhide=true, framelevel=10,
			},
			vehicleicon={ x=-12, y=-26, w=20, h=20, framelevel=6, },
			lfgicon={ x=-12, y=12, w=20, h=20, framelevel=6, circular=true, },
		},
		party2={ frame={ x=16, y=-200, }, },
		party3={ frame={ x=16, y=-280, }, },
		party4={ frame={ x=16, y=-360, }, },
		pettarget={ 
			frame={ hide=true, x=playerx-65, y=playery-19, w=36, h=12, },
			portrait={ x=0, y=0, w=12, h=12, },
			hpbar={ 
				x=12, y=0, w=24, h=9, 
				barcolormethod="hpgreen", bgcolormethod="hpgreendark", bgalpha=0.3, 
		...
		party1target={ frame={ hide=true, x=175, y=-117, }, },
		party2target={ frame={ hide=true, x=175, y=-197, }, },
		party3target={ frame={ hide=true, x=175, y=-277, }, },
		party4target={ frame={ hide=true, x=175, y=-357, }, },
		partypet1={ 
			frame={ x=127, y=-160, w=36, h=12, },
			portrait={ x=0, y=0, w=12, h=12, },
			hpbar={ 
				x=12, y=0, w=24, h=9, 
				barcolormethod="hpgreen", bgcolormethod="hpgreendark", bgalpha=0.3, 
		...
		partypet2={ frame={ x=127, y=-240, }, },
		partypet3={ frame={ x=127, y=-320, }, },
		partypet4={ frame={ x=127, y=-400, }, },
		arena1={
