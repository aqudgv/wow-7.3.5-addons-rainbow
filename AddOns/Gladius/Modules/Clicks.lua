...
local Clicks = Gladius:NewModule("Clicks", false, false, {
	clickAttributes = {
		[L["Left button"]] = { button = "1", modifier = "", action = "target", macro = ""},
		[L["Right button"]] = { button = "2", modifier = "", action = "focus", macro = ""},
	},
})
			...
			action = {
				...
				args = {
					action = {
						...
						values = {["macro"] = MACRO, ["target"] = TARGET, ["focus"] = L["Focus"], ["spell"] = L["Cast Spell"]},
						order = 10,
					},
					sep = {
						type = "description",
