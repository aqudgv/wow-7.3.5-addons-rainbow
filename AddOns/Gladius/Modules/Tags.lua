				...
				add = {
					...
					args = {
						...
						add = {
							...
							order = 15,
							func = function()
								local text = L[self.addTextAttachTo].." "..self.addTextName
...
function Tags:GetTags()
	return {
		...
		["class:short"] = {
			func = "function(unit)\nreturn not Gladius.test and Gladius.L[Gladius.buttons[unit].class..\":short\"] or Gladius.L[Gladius.testing[unit].unitClass..\":short\"]\nend",
			events = "UNIT_NAME_UPDATE",
			preparation = true
		},
		["race"] = {
		...
		["spec"] = {
			func = "function(unit)\nreturn Gladius.test and Gladius.L[Gladius.testing[unit].unitSpec] or Gladius.L[Gladius.buttons[unit].spec]\nend",
