...
PSFeamain3_Textoldv:Show()
	...
	raverschech2=1
print ("|cff99ffff"..raidachievement.."|r - "..ranewversfound)
	end
		end
...
function PSFeavkladdon()
	if (PSFeamain3_CheckButton1:GetChecked()) then
		if(thisaddonworkea)then
			...
			chechtekzoneea()
			out("|cff99ffff"..raidachievement.."|r - "..pseaaddonmy.." |cff00ff00"..pseaaddonon2.."|r.")
		end
	else
			if(thisaddonworkea)then
			out("|cff99ffff"..raidachievement.."|r - "..pseaaddonmy.." |cffff0000"..pseaaddonoff.."|r.")
...
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." "..psealeftmenu5.."!")
end
end
if IsAddOnLoaded("RaidAchievement_Ulduar") then
PSFea_buttonulda2()
...
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." "..psealeftmenu4.."!")
end
end
if IsAddOnLoaded("RaidAchievement_WotlkHeroics") then
whra_button2()
...
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." "..psealeftmenucata.."!")
end
end
if IsAddOnLoaded("RaidAchievement_CataHeroics") then
chra_button2()
...
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." "..psealeftmenupanda.."!")
end
end
if IsAddOnLoaded("RaidAchievement_PandaHeroics") then
phra_button2()
...
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." "..psealeftmenupanda3.."!")
end
end
if IsAddOnLoaded("RaidAchievement_PandaScenarios") then
pzra_button2()
...
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." "..psealeftmenuwod.."!")
end
end
if IsAddOnLoaded("RaidAchievement_WoDHeroics") then
wodhra_button2()
...
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." "..psealeftmenuwod2.."!")
end
end
if IsAddOnLoaded("RaidAchievement_WoDRaids") then
wodrra_button2()
...
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." "..psealeftmenulegion.."!")
end
end
if IsAddOnLoaded("RaidAchievement_LegionHeroics") then
legionhra_button2()
...
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." "..psealeftmenulegion2.."!")
end
end
if IsAddOnLoaded("RaidAchievement_LegionRaids") then
legionrra_button2()
...
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." "..psealeftmenu31.."!")
end
end
if IsAddOnLoaded("RaidAchievement_Naxxramas") then
nxra_button2()
...
if(thisaddonworkea)then
  if IsAddOnLoaded("RaidAchievement_Icecrown")==false then
    ...
    if IsAddOnLoaded("RaidAchievement_Icecrown") then
      print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." "..psealeftmenu6.."!")
    end
  end
  if IsAddOnLoaded("RaidAchievement_Icecrown") then
    icra_button2()
...
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." "..psealeftmenucata2.."!")
end
end
if IsAddOnLoaded("RaidAchievement_CataRaids") then
crra_button2()
...
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." "..psealeftmenupanda2.."!")
end
end
if IsAddOnLoaded("RaidAchievement_PandaRaids") then
prra_button2()
...
print("|cff99ffff"..raidachievement.."|r - "..pseamodulenotload.." "..psealeftmenu5.."! "..raerrormodulereq.." RaidAchievement_OldModules")
end
end
end
...
print("|cff99ffff"..raidachievement.."|r - "..pseamodulenotload.." "..psealeftmenu31.."! "..raerrormodulereq.." RaidAchievement_OldModules")
end
end
end
...
print("|cff99ffff"..raidachievement.."|r - "..pseamodulenotload.." "..psealeftmenu6.."! "..raerrormodulereq.." RaidAchievement_OldModules")
end
end
end
...
print("|cff99ffff"..raidachievement.."|r - "..pseamodulenotload.." "..psealeftmenucata2.."! "..raerrormodulereq.." RaidAchievement_OldModules")
end
end
end
...
print("|cff99ffff"..raidachievement.."|r - "..pseamodulenotload.." "..psealeftmenupanda2.."! "..raerrormodulereq.." RaidAchievement_Pandaria")
end
end
end
...
if loaded then
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." RaidAchievement_WoDRaids!")
else
print("|cff99ffff"..raidachievement.."|r - "..pseamodulenotload.." RaidAchievement_WoDRaids! "..raerrormodulereq.." RaidAchievement_WoD")
end
end
end
...
if loaded then
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." RaidAchievement_LegionRaids!")
else
print("|cff99ffff"..raidachievement.."|r - "..pseamodulenotload.." RaidAchievement_LegionRaids! "..raerrormodulereq.." RaidAchievement_Legion")
end
end
end
...
print("|cff99ffff"..raidachievement.."|r - "..pseamodulenotload.." "..psealeftmenu4.."! "..raerrormodulereq.." RaidAchievement_OldModules")
end
end
end
...
print("|cff99ffff"..raidachievement.."|r - "..pseamodulenotload.." "..psealeftmenucata.."! "..raerrormodulereq.." RaidAchievement_OldModules")
end
end
end
...
print("|cff99ffff"..raidachievement.."|r - "..pseamodulenotload.." "..psealeftmenupanda.."! "..raerrormodulereq.." RaidAchievement_Pandaria")
end
end
end
...
print("|cff99ffff"..raidachievement.."|r - "..pseamodulenotload.." "..psealeftmenupanda3.."! "..raerrormodulereq.." RaidAchievement_Pandaria")
end
end
end
...
if loaded then
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." WoDHeroics!")
else
print("|cff99ffff"..raidachievement.."|r - "..pseamodulenotload.." WoDHeroics! "..raerrormodulereq.." RaidAchievement_WoD")
end
end
end
...
if loaded then
print("|cff99ffff"..raidachievement.."|r - "..pseamoduleload.." LegionHeroics!")
else
print("|cff99ffff"..raidachievement.."|r - "..pseamodulenotload.." LegionHeroics! "..raerrormodulereq.." RaidAchievement_Legion")
end
end
end
...
if nr==1 then
  raerrorframe1:SetText(raerroraddoninst..oldmodules)
elseif nr==2 then
  raerrorframe1:SetText(raerroraddoninst..achievementsreminder)
end
