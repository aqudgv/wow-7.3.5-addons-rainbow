...
L["flyPlateBuffs"] = "增益效果-血條"
L["Show tooltip"] = "顯示滑鼠提示"
L["Show tooltip on mouseover"] = "滑鼠指向時顯示提示說明"
L["Duration"] = "持續時間"
L["Stacks"] = "堆疊層數"
L["Stacks position"] = "層數位置"
L["Above Icon"] = "在圖示上方"
L["Disable debuffs on friendly nameplates"] = "停用友方血條上的減益效果"
L["Working in instances. Disabling them may fix many \"Attempt to access forbidden object\" errors.\nChanges CVar \"nameplateShowDebuffsOnFriendly\""] = "用於副本中，停用時可以修正一直產生的 \"Attempt to access forbidden object\" 錯誤。\n更改 CVar 參數 \"nameplateShowDebuffsOnFriendly\""