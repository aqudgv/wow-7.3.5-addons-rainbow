...
local config = {
	-- format = "{color=level}[isOnline?\"L\"][isOnline?level]{/color} [aliasName|realName] ({color=class}[toonName]{/color})",
	format = "[if=level][color=level]L[=level][/color] [/if][=accountName|name][if=characterName] ([color=class][=characterName][/color])[/if]",
