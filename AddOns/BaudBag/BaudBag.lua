...
function BaudBag_OnLoad(self, event, ...)
    BINDING_HEADER_BaudBag					= Localized.BaudBag;
    BINDING_NAME_BaudBagToggleBank			= Localized.ToggleBank;
    BINDING_NAME_BaudBagToggleVoidStorage	= Localized.ShowVoidStorage;
