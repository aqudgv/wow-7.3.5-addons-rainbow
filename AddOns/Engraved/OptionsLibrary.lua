--[[ Nephilist Options Library v0.2 ]]--
...
function MyAddon:CreateOptionsPanel() 
	local optionsPanel = CreateFrame("Frame", "InterfaceOptions"..addonName.."Panel", InterfaceOptionsFramePanelContainer); 
	...
	optionsPanel.title:SetText("連擊點數-符文字".."  Engraved v"..version);
...
function MyAddon:CreateCheckButton(optionName)
	local checkButton = CreateFrame("CheckButton", nil, self, "InterfaceOptionsCheckButtonTemplate");
