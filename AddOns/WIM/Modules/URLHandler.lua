...
armoryLinks = {
	{
		title = "英雄榜",
		url = "http://tw.battle.net/wow/character/{realm}/{user}/advanced"
	},
    {
		title = "Wowhead Profiler",
		url = "http://www.wowhead.com/profile={eu/us/tw}.{realm-}.{user}",
    },
    {
        title = "Warcraftlogs",
        url = "https://www.warcraftlogs.com/character/{eu/us/tw}/{realm}/{user}"
    },
};
