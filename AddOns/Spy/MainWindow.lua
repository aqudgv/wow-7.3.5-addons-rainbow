...
-- Function to see if a frame is already flashing  -- ?? not used
...
-- Called every frame to update flashing frames  -- ?? Not Used
...
--		end
		...
		theFrame.StatsButton:SetPoint("RIGHT", theFrame.CountButton,"LEFT", -4, 0)
