...
do
    ...
    function HHTD:OnInitialize()
        ...
        if not TSsuccess then
            T._DiagStatus = 2;
            T._Diagmessage = L["Settings transfer from '"] .. oldName .. L["' to '"] .. ADDON_NAME .. L["' failed. "] .. ADDON_NAME ..
            L[" will stay disabled. Error was: "] .. TSstatus .. "\n\n" .. debugstack(2,1,1);
        ...
        self:RegisterChatCommand('補師', function() LibStub("AceConfigDialog-3.0"):Open(tostring(self)) end, true);
