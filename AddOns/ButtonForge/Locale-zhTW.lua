...
Locale["ScaleTooltip"] = "縮放\n|c"..Const.LightBlue.."(點兩下還原預設大小)|r";
Locale["ColsTooltip"] = "新增/移除橫列";
Locale["RowsTooltip"] = "新增/移除直行";
Locale["GridTooltip"] = "隱藏空按鈕\n";
Locale["TooltipsTooltip"] = "顯示提示\n";
Locale["ButtonLockTooltip"] = "鎖定按鈕\n";
Locale["HideVehicleTooltip"] = "進入載具時隱藏按鈕\n";
Locale["HideSpec1Tooltip"] = "使用第一專精時隱藏按鈕\n";
Locale["HideSpec2Tooltip"] = "使用第二專精時隱藏按鈕\n";
Locale["HideSpec3Tooltip"] = "使用第三專精時隱藏按鈕\n";
Locale["HideSpec4Tooltip"] = "使用第四專精時隱藏按鈕\n";
Locale["HideBonusBarTooltip"] = "額外快捷列5啟用時隱藏這個快捷列\n";
Locale["SendToBackTooltip"] = "快捷列層級往後";
Locale["SendToFrontTooltip"] = "快捷列層級往前";
Locale["VisibilityTooltip"] = "使用巨集控制快捷列顯示\n";
Locale["VisibilityEgTooltip"] = "例如 |c"..Const.LightBlue.."[combat]show;hide|r";        --Appended to the Visibility tooltip if no driver is set for that bar
Locale["KeyBindModeTooltip"] = "設定快捷鍵";
Locale["LabelModeTooltip"] = "編輯快捷列標籤";
Locale["AdvancedToolsTooltip"] = "進階設定選項";
Locale["DestroyBarTooltip"] = "刪除快捷列";
Locale["CreateBarTooltip"] = "打造新的快捷列";
Locale["CreateBonusBarTooltip"] = "打造新的額外快捷列\n|c"..Const.LightBlue.."(用於控制載具與特殊寵物)|r";
Locale["RightClickSelfCastTooltip"] = "右鍵點擊為自我施法\n"
Locale["ConfigureModePrimaryTooltip"] = "更多快捷列設定模式\n提示: |c"..Const.LightBlue.."可以將此按鈕拖到所打造的快捷列上|r";
Locale["ConfigureModeTooltip"] = "更多快捷列設定模式";
Locale["BonusActionTooltip"] = "額外快捷列";
...
Locale["Disabled"] = "|c"..Const.DarkOrange.."停用|r";
Locale["CancelPossessionTooltip"] = "取消控制";
Locale["UpgradedChatMsg"] = "更多快捷列儲存的資料已升級成: ";
Locale["DisableAutoAlignmentTooltip"] = "按住 'Shift' 拖曳以停用自動對齊";

--Warning/error messages
Locale["CreateBonusBarError"] = "只在快捷列設定模式中才有效。";
...
Locale["InfoHSpec1"] = "第一專精隱藏";
Locale["InfoHSpec2"] = "第二專精隱藏";
Locale["InfoHSpec3"] = "第三專精隱藏";
Locale["InfoHSpec4"] = "第四專精隱藏";
Locale["InfoHVehicle"] = "進入載具時看見";
Locale["InfoHBonusBar5"] = "額外快捷列5啟用時可見";
