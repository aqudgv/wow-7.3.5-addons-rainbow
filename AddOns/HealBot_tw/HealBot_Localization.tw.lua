...
HEALBOT_OPTIONS_NEWSKINTEXT   = "新外觀"
HEALBOT_OPTIONS_SAVESKIN      = "保存"
HEALBOT_OPTIONS_SKINBARS      = "樣式條外觀選項"
HEALBOT_SKIN_ENTEXT           = "啟用"
HEALBOT_SKIN_DISTEXT          = "停用"
...
HEALBOT_OPTIONS_BARALPHADIS   = "停用透明度"
...
HEALBOT_OPTIONS_EMERGFCLASS   = "設定職業";
...
HEALBOT_TOOLTIP_POSLEFT         = "智能治療左邊";
HEALBOT_TOOLTIP_POSRIGHT        = "智能治療右邊";
HEALBOT_TOOLTIP_POSABOVE        = "智能治療上方";
HEALBOT_TOOLTIP_POSBELOW        = "智能治療下方";
...
HEALBOT_OPTIONS_SETDEFAULTS    = "設定默認";
HEALBOT_OPTIONS_SETDEFAULTSMSG = "恢復所有設定為預設值";
HEALBOT_OPTIONS_RIGHTBOPTIONS  = "右擊圖示打開設定面板";
...
HEALBOT_OPTIONS_DEBUFFTEXT1     = "設定解 Debuff 的技能";
...
HEALBOT_OPTIONS_DISABLEHEALBOT       = "停用智能治療";
...
HEALBOT_OPTIONS_BARBUTTONSHOWHOT  = "持續治療HOT圖示";
HEALBOT_OPTIONS_BARBUTTONSHOWRAIDICON  = "團隊圖示";
...
HEALBOT_OPTIONS_ENABLELIBQH     = "啟用智能治療"
...
HEALBOT_HELP={ [1] = "[HealBot] /hb h -- 顯示幫助",
               [2] = "[HealBot] /hb o -- 切換選項",
               [3] = "[HealBot] /hb ri -- 重置智能治療",
               [4] = "[HealBot] /hb t -- 切換停用和啟用智能治療",
               [5] = "[HealBot] /hb bt -- 切換停用和啟用 Buff 監控",
               [6] = "[HealBot] /hb dt -- 切換停用和啟用 DeBuff 監控",
               [7] = "[HealBot] /hb skin <外觀名字> -- 切換外觀",
               [8] = "[HealBot] /hb ui -- 重載 UI",
               [9] = "[HealBot] /hb hs -- 顯示額外的斜杠命令",
              }

HEALBOT_HELP2={ [1] = "[HealBot] /hb d -- 重置為默認選項",
                [2] = "[HealBot] /hb aggro 2 <n> -- 設定仇恨等級 2 在百分之<n>上",
                [3] = "[HealBot] /hb aggro 3 <n> -- 設定仇恨等級 3 在百分之<n>上",
                [4] = "[HealBot] /hb tr <Role> -- 設定最高優先等級排序. 有效的角色是'TANK', 'HEALER' or 'DPS",
...
HEALBOT_OPTIONS_SKINDEFAULTFOR      = "預設外觀應用於"
...
HEALBOT_OPTIONS_ACCEPTSKINMSG       = "接受 [智能治療] 外觀: "
HEALBOT_OPTIONS_ACCEPTSKINMSGFROM   = " 從 "
HEALBOT_OPTIONS_BUTTONSHARESKIN     = "共用"

HEALBOT_CHAT_ADDONID                = "[智能治療]"
HEALBOT_CHAT_NEWVERSION1            = "有新的可用版本"
HEALBOT_CHAT_NEWVERSION2            = "在 http://healbot.alturl.com"
HEALBOT_CHAT_SHARESKINERR1          = " 共用中沒有發現外觀"
HEALBOT_CHAT_SHARESKINERR3          = " 沒有發現共用外觀"
HEALBOT_CHAT_SHARESKINACPT          = "接受共用外觀 "
HEALBOT_CHAT_CONFIRMSKINDEFAULTS    = "外觀設定為默認"
HEALBOT_CHAT_CONFIRMCUSTOMDEFAULTS  = "重置自定義 Debuffs"
HEALBOT_CHAT_CHANGESKINERR1         = "未知外觀: /hb skin "
HEALBOT_CHAT_CHANGESKINERR2         = "應用外觀:  "
HEALBOT_CHAT_CONFIRMSPELLCOPY       = "當前法術複製到所有規範"
HEALBOT_CHAT_UNKNOWNCMD             = "未知的命令: /hb "
HEALBOT_CHAT_ENABLED                = "進入開啟狀態"
HEALBOT_CHAT_DISABLED               = "進入停用狀態"
HEALBOT_CHAT_SOFTRELOAD             = "請求重載智能治療"
HEALBOT_CHAT_HARDRELOAD             = "請求重載插件"
HEALBOT_CHAT_CONFIRMSPELLRESET      = "法術已經重置"
HEALBOT_CHAT_CONFIRMCURESRESET      = "治療已經重置"
HEALBOT_CHAT_CONFIRMBUFFSRESET      = "Buffs 已經重置"
HEALBOT_CHAT_POSSIBLEMISSINGMEDIA   = "不能接受外觀設定,可能是SharedMedia丟失,請參閱HealBot/Docs/readme.html 鏈結"
...
HEALBOT_CHAT_ACCEPTSKINON           = "共用外觀 - 顯示其他人的共用外觀彈出視窗"
HEALBOT_CHAT_ACCEPTSKINOFF          = "共用外觀 - 總是忽略其他人的外觀共用"
HEALBOT_CHAT_USE10ON                = "自動使用飾品 - 用 10 表示開啟 - 你必須使用現有的飾品"
HEALBOT_CHAT_USE10OFF               = "自動使用飾品 - 用 10 表示關閉"
HEALBOT_CHAT_SKINREC                = "外觀收到自:" 
...
HEALBOT_CHAT_SUBSORTPLAYER1             = "玩家將會被設定為第一優先次序"
HEALBOT_CHAT_SUBSORTPLAYER2             = "玩家將會被設定為正常優先次序"
...
HEALBOT_OPTIONS_TOOLTIPSHOWHOT          = "監視顯示詳細持續治療HOT資訊"
...
HEALBOT_HBMENU                          = "智能治療選單"
HEALBOT_ACTION_HBFOCUS                  = "左鍵點擊設定\n專注目標目標"
HEALBOT_WORD_CLEAR                      = "清除"
HEALBOT_WORD_SET                        = "設定"
HEALBOT_WORD_HBFOCUS                    = "智能治療專注目標"
...
HEALBOT_CMD_RESETSKINS                  = "重置外觀"
HEALBOT_CMD_CLEARBLACKLIST              = "清除黑名單"
HEALBOT_CMD_TOGGLEACCEPTSKINS           = "切換接受其他人共用外觀"
...
HEALBOT_OPTIONS_COMMANDS                = "智能治療命令"
HEALBOT_WORD_RUN                        = "運行"
...
HEALBOT_ACCEPTSKINS                     = "接受他人外觀"
HEALBOT_SUPPRESSSOUND                   = "自動飾品: 禁止聲音"
HEALBOT_SUPPRESSERROR                   = "自動飾品: 停用錯誤提示"
HEALBOT_OPTIONS_CRASHPROT               = "緊急存儲"
HEALBOT_OPTIONS_USEGENERALMACRO         = "使用一般巨集欄位"
HEALBOT_CP_MACRO_LEN                    = "巨集名字字元數必須在 1 至 14 之間."
HEALBOT_CP_MACRO_BASE                   = "基本巨集名稱"
...
HEALBOT_OPTIONS_ALWAYS_SHOW_FOCUS       = "專注目標:始終顯示"
...
HEALBOT_BLIZZARD_MENU                   = "魔獸預設選單"
HEALBOT_HB_MENU                         = "智能治療選單"
HEALBOT_FOLLOW                          = "跟隨"
HEALBOT_TRADE                           = "交易"
...
HEALBOT_RESLAG_INDICATOR_ERROR          = "設定變形保持名字綠色必須在 1 和 30 之間" 
...
HEALBOT_AGGRO2_ERROR_MSG                = "要設定仇恨等級 2, 仇恨值必須在 25 和 95 之間"
HEALBOT_AGGRO3_ERROR_MSG                = "要設定仇恨等級 3, t仇恨值必須在 75 和 100 之間"
HEALBOT_AGGRO2_SET_MSG                  = "設定仇恨百分比為等級 2 "
HEALBOT_AGGRO3_SET_MSG                  = "設定仇恨百分比為等級 3 "
...
HEALBOT_OPTION_ADJUST_MAX_HEALTH        = "調整單位最大生命值"

HEALBOT_WORD_ENABLE                     = "開啟"
HEALBOT_WORD_DISABLE                    = "停用"
...
HEALBOT_ABOUT_FAQ_QUESTIONS = {   [1]   = "Buffs - 為何所有的樣式條都變成白色的?",
                                  ...
                                  [14]  = "選項 - 如何設定?私立坦克?",
                                  [15]  = "選項 - 如何為 NPC 創建狀態欄?",
                                  [16]  = "範圍 - 我不能看到超出範圍的隊員，應該如何解決?",
                                  [17]  = "法術 - 如何設定? 智能治療施放不同的法術?",
                                  [18]  = "法術 - 我可以不再施放治療給沒有受傷的目標嗎?",
                              }

HEALBOT_ABOUT_FAQ_SPELLS_ANSWER01       = "在法術標籤欄的選項設定 \n" ..
                                          "請嘗試更改設定並測試: \n\n" ..
                                          "     1: 在法術選項標籤: 總是使用已啟用的設定； \n" ..
                                          "     2: 在法術選項標籤: 關閉智能施法. \n\n" ..
                                          "注意: 大多數玩家會希望打開智慧施法. \n\n"..
                                          "注意: 有經驗的玩家會希望, \n" ..
                                          "         關閉總是使用已啟用的設定, \n" ..
...
HEALBOT_ABOUT_FAQ_ANSWERS = {     [1]   = "你檢測到消失的 Buffs \n\n" .. 
                                  ...
                                  [3]   = "是的 \n"..
                                          ...
                                          "    end; \n" ..
                                          "    /cast [@hbtarget] 拯救之手\n\n"..
                                          "注意:巨集只有三行,中間段落其實只是間隔空格. \n"..
                                          "    插件會儲存設定的巨集,修改巨集之後要重新選擇.",
                                  [4]   = "是的 \n\n"..
                                          "牧師快速治療,使用兩種飾品: \n\n" ..
                                          "    #show 快速治療 \n" ..
                                  ...
                                  [6]   = "是的 \n\n\n"..
                                          ...
                                          "     2: 在樣式>樣式條 標籤欄, 設定每列小隊數量 \n\n" ..
                                          "不顯示標題: \n" ..
                                          "     1: 在樣式>樣式條 標籤欄, 選擇按編號分列 \n" ..
                                          "     2: 在樣式>樣式條 標籤欄, 設定每列小隊數量 ",
                                  [7]   = "是的 \n\n"..
                                          "1: 在樣式>治療>警告 標籤欄,設定等級為 0 \n" ..
                                          "2: 在樣式>仇恨 標籤欄, 關閉仇恨提醒 \n" .. 
                                          "3: 在樣式>樣式條 標籤欄, 設定停用不透明度為 0 \n" ..
                                          "4: 在樣式>樣式條 標籤欄, 設定背景不透明度為 0 \n" ..
                                          "5: 在樣式>樣式條文本 標籤欄, 單擊 停用 樣式條 \n" ..
                                          "    設定停用文本不透明度為 0 \n" ..
                                          "6: 在樣式>綜合 標籤欄, 點擊 背景顏色 樣式條 \n" ..
                                          "    設定背景不透明度為 0 \n" ..
                                          "7: 在驅散 標籤欄,打開 監測 Debuff ",
                                  [8]   = "是的 \n\n"..
                                          "1: 在樣式>樣式條 標籤欄, 設定進入治療顏色不顯示 \n" ..
                                          "2: 在樣式>樣式條文本 標籤欄, \n" ..
                                          "          設定 顯示生命值 為 否進入治療",
                                  [9]   = "這是自 WoW 3.2 之後的變更, \n" ..
                                          "它會影響名字中帶有怪異字元的角色, \n\n" ..
                                  ...
                                  [15]  = "是的 \n"..
                                          "     1: 在樣式>治療 標籤欄, 打開專注目標 \n" ..
                                          "     2: 設定 NPC 為專注目標(或不在團隊/小隊的玩家) \n" ..
                                          "          智能治療將創建一個你的目標列表樣式條. \n" ..
                                          "注意: 如果你反復進入和脫離戰鬥, \n" ..
                                          "          你需要重設 NPC 為專注目標, \n" ..
                                          "          在樣式>治療 標籤欄設定專注目標:始終顯示, \n" ..
                                          "          這將使樣式條在戰鬥中可用. \n" ..
                                          "注意: 智能治療功能表中有 '智能治療專注目標' 選項 \n" ..
                                          "          這可以使你很容易將 NPC's 設為專注目標, \n" ..
                                          "          並且作為提醒你設定專注目標. \n" ..
                                          "          輸入 'hbmenu' 在法術標籤上使用智能治療功能表, \n" ..
                                          "          或者使用滑鼠滾輪標籤並設定智能治療功能表.",
                                  [16]  = "1:  在樣式>樣式條 標籤欄中, \n" ..
                                              "    調整停用樣式條不透明度 \n" ..
                                          "2:  在樣式>樣式條文本 標籤欄中,  \n" ..
                                          "    調整停用文字不透明度. \n" ..
...
HEALBOT_OPTIONS_SKINAUTHOR              = "外觀作者:"
HEALBOT_OPTIONS_AVOIDBLUECURSOR         = "防止藍色\n滑鼠游標"
HEALBOT_PLAYER_OF_REALM                  = "的"
    ...
    HEALBOT_OPTIONS_ADDON_FAIL              = "無法載入智能治療 HealBot 插件."
    ...
    HEALBOT_OPTIONS_SETTOOLTIP_POSITION     = "設定提示位置"
	...
	HEALBOT_OPTIONS_BARSORIENTATION         = "排列方向"
    ...
    HEALBOT_OPTIONS_BUTTONLOADSKIN          = "載入外觀"
    ...
    HEALBOT_OPTIONS_FOCUS_ONLY_FRIEND       = "專注目標: 僅顯示友好的"
    ...
    HEALBOT_OPTION_NUMENEMYS                = "敵人數目"
    HEALBOT_WORD_AUTO                       = "自動"
	HEALBOT_OPTIONS_ENABLEAUTOCOMBAT        = "啟用智能治療自動戰鬥"
    HEALBOT_WORDS_REMOVETEMPCUSTOMNAME      = "移除暫時的自訂名稱"
    HEALBOT_WORDS_REMOVEPERMCUSTOMNAME      = "移除主要的自訂名稱"
    HEALBOT_WORDS_ADDTEMPCUSTOMNAME         = "加入暫時的自訂名稱"
    HEALBOT_WORDS_ADDPERMCUSTOMNAME         = "加入主要的自訂名稱"
    HEALBOT_OPTIONS_ENABLELIBUTF8           = "啟用 UTF8 函式庫"
    HEALBOT_OPTIONS_SHOWDIRECTION           = "為超出範圍顯示方向箭頭"
    HEALBOT_OPTIONS_SHOWDIRECTIONMOUSE      = "只在滑鼠指向時"
	HEALBOT_LDB_LEFT_TOOLTIP                = "|cffffff00 左鍵:|r 智能治療設定介面";
    HEALBOT_LDB_SHIFTLEFT_TOOLTIP           = "|cffffff00 Shift-左鍵:|r 切換智能治療外觀";
    HEALBOT_LDB_RIGHT_TOOLTIP               = "|cffffff00 右鍵:|r 重設智能治療";
    HEALBOT_LDB_SHIFTRIGHT_TOOLTIP          = "|cffffff00 Shift-右鍵:|r 停用/啟用智能治療";
    HEALBOT_WORD_PETBATTLE                  = "寵物戰鬥"
    HEALBOT_ENEMY_INCLUDE_ARENA             = "包含競技場對手"
    HEALBOT_ENEMY_INCLUDE_ARENAPETS         = "包含戰寵"
    HEALBOT_ENEMY_EXISTS_SHOW_ARENA         = "競技場對手列"
    HEALBOT_CMD_TOGGLECUSTOMCURECASTBY      = "停用/啟用自訂治療者名稱 - 預設治療者名稱為"
	HEALBOT_HEALBOT = "智能治療";
end
