...
function GSA:ShowConfig()
	for i=1,2 do InterfaceOptionsFrame_OpenToCategory(L["GladiatorlosSA"]) end -- ugly fix
end
...
function GSA:AddOption(name, keyName)
	return AceConfigDialog:AddToBlizOptions("GladiatorlosSA", name, L["GladiatorlosSA"], keyName)
end
