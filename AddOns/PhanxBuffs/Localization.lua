...
L["Flametongue"] = "火舌"
L["Frostbrand"] = "冰封"
L["Leeching Poison"] = "吸血毒藥"
L["Left"] = "左"
L["lock"] = "鎖定"
L["Lock Frames"] = "鎖定圖示位置"
...
L["Show Buff Sources"] = "顯示增益效果施法者名字"
L["Show fake buff icons for warrior stances and paladin seals."] = "替戰士的姿勢，以及聖騎士的聖印，顯示假的增益效果圖示。"
L["Show Stance Icons"] = "顯示姿勢圖示"
L["Show the name of the party or raid member who cast a buff on you in its tooltip."] = "在滑鼠提示中顯示對你施放增益效果的隊伍或團隊成員名字。"
L["Show weapon buffs as the spell or item that buffed the weapon, instead of the weapon itself."] = "將武器特效和物品所觸發的武器特效，顯示為法術技能效果，而不是顯示武器本身。"
L["Text Outline"] = "文字外框"
L["Text Size"] = "文字大小"
L["Thick"] = "粗"
L["Thin"] = "細"
...
L["Weapon Buff Sources"] = "武器特效來源"
L["Windfury"] = "風怒"
L["Wound Poison"] = "致傷毒藥"
L["PhanxBuffs"] = "增益效果"
L["%d minutes remaining"] = "還有 %s 分鐘"
L["%d seconds remaining"] = "還有 %s 秒"
