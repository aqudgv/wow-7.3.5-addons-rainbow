...
local mousescroll = newCheckbox(panel, 'mousescroll', '使用滑鼠滾輪旋轉', "使用滑鼠滾輪旋轉預覽模型。")
...
local anchor = newDropdown(panel, 'anchor', "裝備預覽要對齊滑鼠提示的哪個方向，會依據畫面顯示位置調整。", {
    vertical = "上 / 下",
    horizontal = "左 / 右",
})
...
SlashCmdList.APPEARANCETOOLTIP = function(msg)
    InterfaceOptionsFrame_OpenToCategory("塑形-預覽")
    InterfaceOptionsFrame_OpenToCategory("塑形-預覽")
end
