...
-- New strings in 4.7.11
	L["Use Level In Strong Vs Filter"] = "使用足夠強力 Vs 過濾方式"
	L["When doing a Strong Vs filter, take the level of the pet into account. If a pet is not high enough level to use a Strong Vs ability, do not list the pet.\n\n\124cffffffffNote:\124r A Strong Vs filter is sometimes useful for identifying pets you want to level or capture. This option will hide those pets while the Strong Vs filter is active."] = "使用強力 Vs 過濾方式時，選擇足以達到該水準的寵物。如果寵物的水準不足以使用強力 Vs 技能，則不要列出該寵物。\n\n\124cffffffff注意:\124r 強力 Vs 過濾方式通常對於想要升級或捕捉的寵物非常有用，啟用強力 Vs 過濾方式時，這個選項會隱藏這些寵物。"

-- New strings in 4.7.10
	L["Unique Pets In the Journal"] = "日誌中的不重複寵物"
	L["There are %s%d\124r unique pets in the journal"] = "日誌中的不重複寵物有 %s%d\124r 個。"
	L["You have %s%.1f%%\124r of those unique pets"] = "這些不重複的寵物中，你有 %s%.1f%%\124r。"
	L["All unique pets in the journal. This is all obtainable unique pets."] = "日誌中所有不重複的寵物，這是全部可以取得的不重複寵物。"
	
-- New strings in 4.7.9
	L["Allow Any Version"] = "允許任何屬性"
	L["Instead of choosing only the healthiest pet with identical stats, choose the healthiest version of the pet regardless of stats."] = "不論屬性，選擇生命力最高的任何寵物，而不是選擇不同屬性生命力最高的寵物。"

-- New strings in 4.7.8
	L["Allow Hidden Pets"] = "允許隱藏寵物"
	L["Allow the ability to hide specific pet species in the pet list with a 'Hide Pet' in the list's right-click menu.\n\nYou can view pets you've hidden from the Other -> Hidden Pets filter."] = "只要在寵物清單的滑鼠右鍵選單中選擇 '隱藏寵物'，便可以隱藏指定的寵物。\n\n從過濾方式 -> 其他 -> 隱藏寵物，可以查看已經被隱藏的寵物。"
	L["Debug: Journal FrameLevel"] = "除錯: 寵物日誌框架層級"
	L["If you experience problems opening Rematch in the Collections window, and the standalone window works fine, then check this to see if it helps. Let me know if it does or doesn't, thanks!"] = "如果在收藏視窗中開啟戰寵送作隊發生問題，但是在獨立視窗中開啟沒有問題，請試試看這個選項是否有幫助。並且請告知我它是否真的有用，感謝!"

-- New strings in 4.7.8
	L["Delete Teams"] = "刪除隊伍"
	L["Permanently delete all teams in this tab."] = "永久性的刪除這個標籤頁面中的所有隊伍，無法還原。"
	L["Delete Teams?"] = "刪除隊伍?"
	L["Delete ALL teams in the first tab?"] = "確定要刪除第一個標籤頁的全部隊伍?"
	L["Delete this tab and either move all of its teams to the default tab or delete the teams too."] = "刪除這個標籤頁面，將裡面的所有隊伍移動到預設的標籤頁面，或是連隊伍一起刪除。"

-- New strings in 4.7.6
	L["Mac'Aree"] = "麥克艾瑞"
	L["Krokuun"] = "克庫恩"
	L["Antoran Wastes"] = "安托洛斯荒原"
	L["Show Species ID & Ability ID"] = "顯示種類ID & 技能ID"
	L["Display the numerical species ID of a pet as a stat on their pet card and the numerical ability ID on ability tooltips."] = "在寵物卡的狀態欄中顯示種類ID數字，在技能的滑鼠提示中顯示技能ID數字。"

-- New strings in 4.7.3
	L["Shared Moveset"] = "共同技能組"
	L["In addition to the flyouts, show the numbers 1 and 2 on loaded abilities."] = "除了彈出式的按鈕以外，也要在載入的技能上面顯示數字 1 和 2。"
	L["When a team auto loads, show the Rematch window if any pets in the team are injured."] = "自動載入隊伍時，如果隊伍內有任何寵物受傷，便自動顯示戰寵送作隊視窗。"
	L["Only list pets that can battle. Do not list pets like balloons, squires and other companion pets that cannot battle."] = "只列出可以戰鬥的寵物，不要列出像是氣球、隨從和其他只能陪伴而不能戰鬥的寵物。"
	L["Moveset"] = "技能組"
	L["Unique Moveset"] = "獨特技能組"
	L["This will export all teams across all tabs into text that you can paste elsewhere, such as an email to yourself or a text file someplace safe. You can later restore these teams with the Import Teams option."] = "將所有標籤頁的所有隊伍匯出成文字，以便在其他任何地方貼上，例如寄送電子郵件給自己，或是將文字檔案放置在某個安全的地方。日後可以使用匯入隊伍選項來恢復這些隊伍。"
	L["Hide Non-Battle Pets"] = "隱藏非戰鬥寵物"
	L["Find Moveset"] = "尋找技能組"
