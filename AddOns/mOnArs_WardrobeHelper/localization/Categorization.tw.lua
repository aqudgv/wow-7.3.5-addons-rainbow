...
c["風暴核心"] = {2, 2, "The Eye"}
c["三傑議會之座"] = {7, 1, "Seat of the Triumvirate"}
c["侵略點"] = {7, 2, "Invasion Points"}
c["永夜聖殿"] = {7, 1, "Cathedral of Eternal Night"}
c["重返卡拉贊"] = {7, 1, "Return to Karazhan"}
c["勇氣試煉"] = {7, 2, "Trial of Valor"}
c["薩格拉斯之墓"] = {7, 2, "Tomb of Sargeras"}
c["安托洛斯，燃燒王座"] = {7, 2, "Antorus, the Burning Throne"}
