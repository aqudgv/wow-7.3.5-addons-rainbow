...
local TYPES = {
	o.strings['Boss drop'], o.strings['Quests'], o.strings['Vendor'], o.strings['World/Instance Drop'], o.strings['Achievements'], o.strings['Professions']
}

TYPES[0] = o.strings['Other']
...
o.difficulties["N"] = {o.strings["Normal"], PLAYER_DIFFICULTY1}
...
o.LDB = LibStub("LibDataBroker-1.1"):NewDataObject("Wardrobe Helper", {
	type = "launcher",
	text = o.strings["Wardrobe Helper"],
	icon = "Interface\\Icons\\INV_Chest_Cloth_17",
	OnClick = function() o.GUIopen() end,
	OnTooltipShow = function(tooltip)
		tooltip:AddLine(o.strings["Wardrobe Helper"])
	end,
})
									...
									if sourceType == 1 then
										...
										for k=1,#drops do
											...
											if #inst.difficulties == 0 then
												inst.difficulties[1] = PLAYER_DIFFICULTY1
											end
	...
	if WardrobeCollectionFrame then
		if WardrobeCollectionFrame.NavigationFrame then
			if mOnWD_MainFrame_bShow == nil then
				...
				b:SetText(o.strings["Wardrobe Helper"])
				b:SetHeight(25);
				b:SetWidth(120);
