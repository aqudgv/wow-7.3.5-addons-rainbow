...
NS.Print = function( msg )
	print( ORANGE_FONT_COLOR_CODE .. "<|r" .. NORMAL_FONT_COLOR_CODE .. NS.localization[NS.addon] .. "|r" .. ORANGE_FONT_COLOR_CODE .. ">|r " .. msg );
end
--
...
NS.SecondsToStrTime = function( seconds, colorCode )
	...
	--
	local strTime = ( days > 0 and hours == 0 and days .. NS.localization[" day"] ) or ( days > 0 and days .. NS.localization[" day "] .. hours .. NS.localization[" hr"] ) or ( hours > 0 and minutes == 0 and hours .. NS.localization[" hr"] ) or ( hours > 0 and hours .. NS.localization[" hr "] .. minutes .. NS.localization[" min"] ) or ( minutes > 0 and minutes .. NS.localization[" min"] ) or seconds .. NS.localization[" sec"];
...
NS.StrTimeToSeconds = function( str )
	...
	local M = function( i )
		if i == NS.localization["hr"] then
			return 3600;
		elseif i == NS.localization["min"] then
			return 60;
		elseif i == NS.localization["sec"] then
			return 1;
		else
			return 86400; -- day
		end
