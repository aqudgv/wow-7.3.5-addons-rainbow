...
function D:OnInitialize() -- Called on ADDON_LOADED by AceAddon -- {{{
    ...
    self:RegisterChatCommand("驅散"		    ,function() LibStub("AceConfigDialog-3.0"):Open(D.name) end         );
    self:RegisterChatCommand("一鍵驅散"	    ,function() LibStub("AceConfigDialog-3.0"):Open(D.name) end         );
