...
L["WeakAuras Options"] = "WA技能提醒的設定選項"
L[" will finish loading after combat."] = " 將於戰鬥結束後載入。"
L[" could not be loaded: "] = " 無法載入："
L[" will open after combat."] = " 將於戰鬥結束後開啟。"
L["WeakAurasModelPaths"] = "WA技能提醒的模組路徑"
L["WeakAurasTemplates"] = "WA技能提醒的範本"
L["WeakAuras Anchor"] = "WA技能提醒的對齊位置"